...
namespace lbm {
  ...
  template <class T>
  class Equilibrium<T, LatticeType::D1Q3, EquilibriumType::Exact>
    : public Equilibrium<T, LatticeType::Generic, EquilibriumType::Exact> {
  public:
  ...
  template <class T>
  class Equilibrium<T, LatticeType::D2Q9, EquilibriumType::Exact>
    : public Equilibrium<T, LatticeType::D1Q3, EquilibriumType::Exact> {
  public:
    LBM_DEVICE LBM_HOST static inline
    T calculate(const T& density, const MathVector<T, L::dimD>& velocity,
                const T& velocity2, const unsigned int iQ) {
    ...
    template <class T>
  class Equilibrium<T, LatticeType::D2Q13, EquilibriumType::Exact>
    : public Equilibrium<T, LatticeType::D1Q3, EquilibriumType::Exact> {
  public:
    LBM_DEVICE LBM_HOST static inline
    T calculate(const T& density, const MathVector<T, L::dimD>& velocity,
  ...
  template <class T>
  class Equilibrium<T, LatticeType::D3Q27, EquilibriumType::Exact>
    : public Equilibrium<T, LatticeType::D1Q3, EquilibriumType::Exact> {
  public:
    LBM_DEVICE LBM_HOST static inline
    T calculate(const T& density, const MathVector<T, L::dimD>& velocity,
