...
namespace lbm {
  ...
  public:
    ...
    inline void closeFile() {
      Base::statusHDF5 = H5Fclose(Base::fileHDF5);
    ...
    inline void open(const std::string& fileName) {
      ...
      Base::fileHDF5 = H5Fopen(fileName.c_str(), H5F_ACC_RDONLY, Base::propertyListHDF5);
    ...
    template<Architecture architecture>
      ...
      { LBM_SCOREP_INSTRUMENT_ON("Reader<T, InputOutput::HDF5, readerFileFromat>::readField<NumberComponents>",3) }
        ...
        for(auto iC = 0; iC < L::dimQ; ++iC) {
          ...
          Base::dataSetHDF5 = H5Dopen1(Base::fileHDF5, (distribution.fieldName+std::to_string(iC)).c_str());
