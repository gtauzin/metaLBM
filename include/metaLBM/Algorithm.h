  ...
  Algorithm(FieldList<T, architecture>& fieldList_in,
      ...
      : Base(fieldList_in,
        ...
        computationLocal(lSD::sStart() + L::halo(),
                         ...
                         {d::X, d::Y, d::Z}),
        computationBottom(
            {hSD::start()[d::X], L::halo()[d::Y], hSD::start()[d::Z]},
            {hSD::end()[d::X], 2 * L::halo()[d::Y], hSD::end()[d::Z]},
            {d::X, d::Z, d::Y}),
        computationTop(
            {hSD::start()[d::X], L::halo()[d::Y] + lSD::sLength()[d::Y] - 1,
             hSD::start()[d::Z]},
            {hSD::end()[d::X], 2 * L::halo()[d::Y] + lSD::sLength()[d::Y] - 1,
             hSD::end()[d::Z]},
            {d::X, d::Z, d::Y}),
        computationFront(
            {hSD::start()[d::X], hSD::start()[d::Y], L::halo()[d::Z]},
...
#pragma unroll
  ...
  void iterate(const unsigned int iteration,
    ...
    computationFront.Do(stream, frontBoundary,
                        Base::haloDistributionPrevious_Ptr);
