...
struct Packer {
 public:
  LBM_DEVICE LBM_HOST inline void operator()(
      const Position& iP,
      T* const local,
      T* halo,
...
template <class T,
          ...
          Implementation implementation,
          unsigned int Dimension>
class BottomBoundary : public Boundary<T,
                                       boundaryType,
                                       algorithmType,
                                       partitionningType,
                                       implementation,
...
template <class T,
          ...
          Implementation implementation,
          unsigned int Dimension>
class TopBoundary : public Boundary<T,
                                    boundaryType,
                                    algorithmType,
                                    partitionningType,
                                    implementation,
...
template <class T,
          ...
          Implementation implementation,
          unsigned int Dimension>
class FrontBoundary : public Boundary<T,
                                      boundaryType,
                                      algorithmType,
                                      partitionningType,
                                      implementation,
...
template <class T,
          ...
          Implementation implementation,
          unsigned int Dimension>
class BackBoundary : public Boundary<T,
                                     boundaryType,
                                     algorithmType,
                                     partitionningType,
                                     implementation,
...
template <class T,
          ...
          unsigned int Dimension>
class Boundary<T,
               BoundaryType::BounceBack_Halfway,
               algorithmType,
               partitionningType,
               implementation,
               Dimension> : public Boundary<T,
                                            BoundaryType::Generic,
                                            algorithmType,
                                            PartitionningType::Generic,
                                            Implementation::Generic,
                                            Dimension> {
